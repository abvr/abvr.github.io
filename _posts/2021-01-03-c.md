...
For a trajectory to approach within 1m from event horizon it must be either of the type $$𝐸̃_3$$ or $$𝐸̃_4$$. $$𝐸̃_3$$ corresponds to the trajectory of the particle falling into the black hole, while $$𝐸̃_4$$ is a geodesic that starts and ends on the horizon.
